...
Разработка простого **CI/CD** для проекта *Bash_Utilities*. Сборка, тестирование, развертывание.
...
2. [Chapter II](#chapter-ii) \
   2.1. [Part 1. Настройка gitlab-runner](#part-1-настройка-gitlab-runner)  
   2.2. [Part 2. Сборка](#part-2-сборка)  
   2.3. [Part 3. Тест кодстайла](#part-3-тест-кодстайла)   
   2.4. [Part 4. Интеграционные тесты](#part-4-интеграционные-тесты)  
   2.5. [Part 5. Этап деплоя](#part-5-этап-деплоя)  
   2.6. [Part 6. Уведомления](#part-6-уведомления)
...
#### Написать этап для **CI** по сборке приложений из проекта *Bash_Utilities*:
...
В результате вы должны получить готовые к работе приложения из проекта *Bash_Utilities* (s21_cat и s21_grep) на второй виртуальной машине.
